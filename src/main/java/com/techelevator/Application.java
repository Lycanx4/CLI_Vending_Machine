...
public class Application {
	...
	public static boolean isFirstMenuOk(Scanner userInput, VendingMachine vm){
		...
		if (decision.equals("1")) {
			...
			userInput.nextLine();
			System.out.println();
			//recaching; essentially saying that if the condition is satisfied, pressing enter,
	...
	public static void hiddenMethod(VendingMachine vm, Scanner scanner, int attempt
		...
		if(str.equals("techelevator1")){
			...
			//formatting string to reset message in console to default color
			String RESET = "\u001B[0m";
			//formatting string to change text in console to red
			String RED = "\u001B[31m";

			System.out.println(RED + "Failed to enter password, self-destruction initiated...");
			try {
			...
			System.out.println(RESET + "Just kidding! Let's go back to the main menu. Shall we :)");
